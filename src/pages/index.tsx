    ...
    <>
        ...
        <div className={"pb-3 flex fixed inset-x-0 justify-center bottom-0 text-center space-x-4"}>
            <Link href={"https://github.com/00raymond/wordpop"} target={"_blank"}>
              <button><svg className="w-8 h-8 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
